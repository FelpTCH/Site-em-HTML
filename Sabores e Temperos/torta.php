...
<head>
    ...
    <title>Torta de Maçã - Site de Receitas</title>
...
<div class="container my-5">
    <div class="row">
        <div class="col-md-6">
            <img src="assets/images/tortamaca.png" class="img-fluid" alt="Torta de Maçã">
        </div>
        <div class="col-md-6">
            <h1>Torta de Maçã</h1>
            <p><strong>Descrição:</strong> Uma torta clássica e irresistível, com recheio de maçãs caramelizadas e massa crocante. Perfeita para a sobremesa ou lanche da tarde!</p>

            <h3>Ingredientes:</h3>
            <ul>
                <li>4 maçãs descascadas e fatiadas</li>
                ...
                <li>Massa pronta ou caseira para torta (base e cobertura)</li>
            ...
            <ol>
                ...
                <li>Em uma tigela, misture as maçãs com açúcar, canela, limão e farinha.</li>
                <li>Forre uma forma com a base da massa, adicione o recheio e coloque pedacinhos de manteiga por cima.</li>
                <li>Cubra com o restante da massa, faça cortes pequenos para ventilação e pincele com o ovo batido.</li>
                <li>Asse por cerca de 40 minutos ou até dourar bem.</li>
            </ol>
