...
<head>
    ...
    <title>Lasanha de Carne - Site de Receitas</title>
...
<div class="container my-5">
    <div class="row">
        <div class="col-md-6">
            <img src="assets/images/lasanha.png" class="img-fluid" alt="Lasanha de Carne">
        </div>
        <div class="col-md-6">
            <h1>Lasanha de Carne</h1>
            <p><strong>Descrição:</strong> Uma clássica e suculenta lasanha de carne moída, com molho vermelho, molho branco e bastante queijo. Perfeita para o almoço em família.</p>
            ...
            <ol>
                <li>Refogue a cebola e o alho no óleo, adicione a carne moída e cozinhe até dourar.</li>
                <li>Acrescente o molho de tomate, tempere com sal e pimenta, e deixe cozinhar por 10 minutos.</li>
                <li>Para o molho branco, derreta a manteiga, adicione a farinha e cozinhe por 1 minuto. Adicione o leite aos poucos, mexendo até engrossar. Tempere com sal e noz-moscada.</li>
                <li>Em um refratário, monte camadas de massa, carne, molho branco e queijo, repetindo até acabar os ingredientes. Finalize com queijo.</li>
                <li>Asse em forno preaquecido a 180°C por 30 minutos ou até gratinar.</li>
            </ol>
