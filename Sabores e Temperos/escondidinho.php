...
<div class="container my-5">
    <div class="row">
        <div class="col-md-6">
            <img src="assets/images/escondidinho.png" class="img-fluid" alt="Escondidinho de Carne">
        </div>
        <div class="col-md-6">
            <h1>Escondidinho de Carne</h1>
            <p><strong>Descrição:</strong> Uma receita deliciosa de escondidinho com purê de batata cremoso e recheio suculento de carne moída bem temperada.</p>
            ...
            <ul>
                ...
                <li>5 batatas médias cozidas e amassadas</li>
            ...
            <ol>
                ...
                <li>Acrescente o extrato de tomate, tempere com sal, pimenta e cheiro-verde. Reserve.</li>
                <li>Prepare o purê misturando a batata amassada com manteiga e leite até ficar cremoso.</li>
                <li>Em um refratário, espalhe metade do purê, cubra com a carne e finalize com o restante do purê.</li>
                <li>Polvilhe o queijo por cima e leve ao forno a 200°C por 20 minutos ou até gratinar.</li>
            </ol>
