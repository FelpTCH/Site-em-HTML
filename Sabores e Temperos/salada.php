...
<head>
    ...
    <title>Salada Refrescante - Site de Receitas</title>
...
<div class="container my-5">
    <div class="row">
        <div class="col-md-6">
            <img src="assets/images/salada.png" class="img-fluid" alt="Salada Refrescante">
        </div>
        <div class="col-md-6">
            <h1>Salada Refrescante</h1>
            <p><strong>Descrição:</strong> Uma salada leve, colorida e cheia de sabor. Perfeita para dias quentes ou para acompanhar qualquer refeição!</p>

            <h3>Ingredientes:</h3>
            <ul>
                <li>1 xícara de alface americana picada</li>
                <li>1/2 xícara de rúcula</li>
                <li>1/2 xícara de tomate-cereja cortado ao meio</li>
                <li>1/4 de xícara de cenoura ralada</li>
                <li>1/2 pepino cortado em rodelas finas</li>
                <li>1/4 de xícara de milho cozido</li>
                <li>Suco de 1 limão</li>
                <li>Sal e azeite a gosto</li>
            </ul>

            <h3>Modo de Preparo:</h3>
            <ol>
                <li>Lave bem todos os ingredientes.</li>
                <li>Em uma tigela grande, misture todos os vegetais.</li>
                <li>Tempere com limão, azeite e sal a gosto.</li>
